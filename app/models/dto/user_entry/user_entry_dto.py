...
class UserEntryDto:
    ...
    def __init__(self, book_scan_entry: list[BookScanEntryDto], diction_entry: list[DictionEntryDto],
                 img_entry: list[ImgEntryDto], video_entry: list[VideoEntryDto]):
        self.book_scan_entry = book_scan_entry
        self.diction_entry = diction_entry
        self.img_entry = img_entry
